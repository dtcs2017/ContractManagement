...
<html lang="en">
  <head>
    ...
    <!-- Custom Theme Style -->
    <link href="../plugins/custom/css/custom.min.css" rel="stylesheet">
  </head>
  ...
  <body class="nav-md">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>é¦é¡µ</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> ç³»ç»ç®¡ç <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                    	<li><a href="jsp/userList.jsp">ç¨æ·åè¡¨</a></li>
                    	<li><a href="index.html">è§è²åè¡¨</a></li>
                    	<li><a href="index.html">æéåè¡¨</a></li>
    ...
    <script src="../plugins/custom/js/custom.min.js"></script>
